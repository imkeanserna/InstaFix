...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 rounded-full opacity-0 transition-opacity group-hover:opacity-60",
        orientation === "horizontal"
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex gap-1 justify-center items-center mt-4",
        className
      )}
      {...props}
    >
        ...
        <button
          ...
          className={cn(
            ...
            index === selectedIndex
              ...
              : "bg-white/40 hover:bg-foreground/50 h-[5px] w-[5px]"
          )}
