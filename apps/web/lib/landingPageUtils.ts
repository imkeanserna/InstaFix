...
export const HERO_SECTION_CONFIG = {
  ...
  description:
    "Connect instantly with AI-powered experts who fix your problems fast, easy and hassle-free",
...
export const OVER_ALL_TESTIMONIAL =
  "/home-page/testimonial-hero/testimonals-overall.webp";
...
export const SECTION_CONFIG = [
  {
    ...
    videoUrl:
      "https://www.loom.com/embed/b0289c0e6cb540e597c78c487f99df56?sid=1323467b-2ec6-4321-b96b-8554c31a1384",
  },
  {
...
export const HEADING_AI_SECTION = {
  ...
  subheading:
    "your personal AI assistant 🤖, connecting you with expert freelancers instantly.",
  mobileHeading:
    "Introducing InstaFix Assistant your <span class='text-yellow-400 italic text-[2.3rem]'>personal AI assistant</span> 🤖, connecting you with expert freelancers instantly.",
};
...
export const MOBILE_SECTION = {
  ...
  description:
    "Enhance your freelancing experience, grow your income, and enjoy a seamless, user-friendly app that effortlessly connects you with clients.",
  mobileImage: "/home-page/mobile-view.avif",
  features: [
    {
      title: "Skill Up, earn more",
      description:
        "With thousands of users looking for expert help, you'll always find new opportunities. The more you work, the more you earn!",
    },
    {
      title: "Set your own schedule",
      description:
        "Be your own boss choose when to work and take on projects that fit your time.",
    },
    {
      title: "Maximize Your Earnings",
      description:
        "Earn instantly with no hidden fees. Unlock exclusive deals and incentives as you grow!",
    },
  ],
};
    ...
    sections: [
      {
        ...
        buttonText: "Users",
        description:
          "Get your problems fixed quickly and affordably by skilled freelancers 🛠️.",
      ...
      },
      {
        ...
        subDescription:
          "+ Unlock exclusive job opportunities based on your skills and experience.",
...
export const CALLTOACTION = {
  ...
  config: {
    ...
    description:
      "Find top freelancers, post your projects, and get matched instantly. Work on your schedule, hire with confidence, and fuel your success with Instafix.",
    ...
    sections: [
      {
        ...
        subdescription:
          "Crafted by skilled freelancers who know the hustle balancing speed, quality, and efficiency.",
      },
      {
        type: "form",
        heading: "The latest Instafix insights delivered to your inbox",
        subdescription:
          "By submitting this form, you consent to Instafix processing your data and contacting you to fulfill your request. For more information on how we are committed to protecting and respecting your privacy, please review our Privacy Policy.",
