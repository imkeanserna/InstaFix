...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: "/favicon/favicon.ico" }, { url: "/favicon/icon1.png" }],
                    ...
                    <ReactQueryProvider>
                      <FormDataProvider>
                        <NotFoundProvider>
                          ...
                          <Analytics />
                          <AuthModal />
                          <HomeFooter className="bg-gradient-to-b relative from-yellow-500 to-yellow-900 overflow-hidden px-4 md:px-12 lg:px-24 py-10 md:py-16 " />
                        </NotFoundProvider>
                      </FormDataProvider>
                    </ReactQueryProvider>
                  </ChatProvider>
